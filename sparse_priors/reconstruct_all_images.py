...
if __name__ == "__main__":
    for experiment in experiments:
        ...
        for config in configs:
            ...
            result_dir = os.path.join('results_3d', protein, prior, f"block_{block_size}_masks_{num_masks}_{mask_type}")
            results_2d_dir = os.path.join('results', protein, prior, f"block_{block_size}_masks_{num_masks}_{mask_type}")
